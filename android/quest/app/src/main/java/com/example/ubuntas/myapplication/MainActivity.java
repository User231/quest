    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showChat = !showChat;
                findViewById(R.id.map).setVisibility(showChat ? View.INVISIBLE : View.VISIBLE);
                findViewById(R.id.content_chat).setVisibility(!showChat ? View.INVISIBLE : View.VISIBLE);
            }
        });
        ...
        mapActivity.init((SupportMapFragment)getSupportFragmentManager().findFragmentById(R.id.map));
